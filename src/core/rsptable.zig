...
//!
//! rsptable.zig - Reality Signal Processor ROM tables. 
//!

// Taken from Dillonb's N64 emulator (https://github.com/Dillonb/n64/blob/master/src/cpu/rsp_rom.h)

pub const rcpROM = [_]u16 {
